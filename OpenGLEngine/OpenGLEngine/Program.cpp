...
bool Program::Init(int argc, char** argv)
{
    ...
    shaderGeometryPass = new Shader("Shaders/gbuffer.vert", "Shaders/gbuffer.frag");
    shaderLightingPass = new Shader("Shaders/deferredlighting.vert", "Shaders/deferredlighting.frag");
    stencilPassShader = new Shader("Shaders/simple.vert","Shaders/simple.frag");
    ...
    faces.push_back("CubeMap/UFTest_m00_c00.bmp");
    faces.push_back("CubeMap/UFTest_m00_c01.bmp");
    faces.push_back("CubeMap/UFTest_m00_c02.bmp");
    faces.push_back("CubeMap/UFTest_m00_c03.bmp");
    faces.push_back("CubeMap/UFTest_m00_c04.bmp");
    faces.push_back("CubeMap/UFTest_m00_c05.bmp");
    
    GLuint cubemapTexture = ImageLibManager::Instance()->LoadIBLCubeMap("CubeMap/UFTest",8);//ImageLibManager::Instance()->loadCubemap(faces);

    Panorama = new Texture();
	Panorama->id = cubemapTexture;//ImageLibManager::Instance()->LoadIBLCubeMap("CubeMap/UFTest",7);
...
void Program::LightPass()
{
    ...
    glUniform1f(glGetUniformLocation(shaderLightingPass->GetShader(), "roughnessValue"),0.2f);
